README.txt for Notion Paste HTML module
---------------------------------------------
...
-------------
  ...
  * After installing, go to: Admin->Configuration->Content Authoring->Text formats and editors

  * Configure any of the Text Formats for which you want to have the Notion feature enabled.

  * From the Available buttons, drag drop the Notion button to the Active toolbar.
